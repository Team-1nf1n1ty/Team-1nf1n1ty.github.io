        ...
        <div class="container-all">
            ...
            <div class="data-container">
                ...
                <p class="mt-4 text-white text-l">
                    Team 1nf1n1ty is a top student CTF team in India looking for new members who are passionate about
                    cybersecurity and hacking challenges. As a member, you'll work on challenging problems, improve your
                    skills, and participate in competitions. We're looking for dedicated individuals with a solid
                    foundation in cybersecurity and hacking concepts. Apply now if you're excited to join a top CTF team
...
export default {
    ...
    methods: {
        ...
        async notify() {
            ...
            try {
                const response = await axios.post('/api/notify', { email: this.form.email, name: this.form.name });
